<{$params.tag->getValue()}
    ...
    class="nav-item{if $params.class->hasValue()} {$params.class->getValue()}{/if}"
    ...
    {/if}
>
    <{$params['router-tag']->getValue()} class="nav-link {if $params['router-class']->hasValue()}{$params['router-class']->getValue()}{/if}
