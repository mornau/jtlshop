<select
    ...
    {if $params.multiple->getValue() === true}multiple{/if}
    ...
    class="form-control{if $params.class->hasValue()} {$params.class->getValue()}{/if}
    {if $params.size->hasValue()}form-control-{$params.size->getValue()}{/if}
"
