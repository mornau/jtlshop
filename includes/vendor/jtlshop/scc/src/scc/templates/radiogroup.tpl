...
<div
    class="{$params.class->getValue()}{if $params.buttons->getValue() === true} btn-group-toggle btn-group{if $params.stacked->getValue() === true}-vertical{/if} btn-group-{$params.size->getValue()}{/if}"
    id="{$id}"
